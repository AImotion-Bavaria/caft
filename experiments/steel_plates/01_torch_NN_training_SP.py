...
if __name__ == "__main__":
    ...
    for run in range(1, 11):
        ...
        RESULTS_PATH = paths.BASE_DIR / "artifacts" / "results" / "_steel_plates" / EXPERIMENT_NAME / f"DATA_SPLIT_STATE_{DATA_SPLIT_STATE}" / "test_runs_CE" 
        MODEL_PATH = paths.BASE_DIR / "artifacts" / "models" / "model_weights" / "_steel_plates" / EXPERIMENT_NAME / f"DATA_SPLIT_STATE_{DATA_SPLIT_STATE}" / "normal_loss"
