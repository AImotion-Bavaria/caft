...
COST_INCREMENT = 1             # How much to increase lambda per cost step
...
if __name__ == "__main__":
    ...
    for run in range(1, 11):
        ...
        RESULTS_PATH = paths.BASE_DIR / "artifacts" / "results" / "_steel_plates" / EXPERIMENT_NAME / f"DATA_SPLIT_STATE_{DATA_SPLIT_STATE}" / "test_runs_constraint_aware_stepwise_WCE"
        ...
        sys.stdout = SaveOutput(RESULTS_PATH / f"steel_plates_results_constraint_aware_stepwise_{run}.txt")
